...
- (void)setConfig:(NSDictionary *)params{
    ...
    id sampleRate = [FTUniPluginUtils firstValueInDictionary:params
                                                 primaryKey:@"sampleRate"
                                                fallbackKey:@"samplerate"];
    if (sampleRate != nil) {
        rumConfig.sampleRate = [sampleRate doubleValue] * 100;
    }
